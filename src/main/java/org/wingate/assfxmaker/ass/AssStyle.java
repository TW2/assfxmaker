 ...
 */
package org.wingate.assfxmaker.ass;
...
public class AssStyle {
    ...
    public static AssStyle create(String ASS){
        ...
        // 16 - Outline
        style.setOutline(Float.parseFloat(array[16]));
        // 17 - Shadow
        style.setShadow(Float.parseFloat(array[17]));
        // 18 - Alignment
    ...
    public static String getStyle(){
        ...
        return "Style: "
                ...
                + Float.toString(style.Outline) + ","
                + Float.toString(style.Shadow) + ","
    ...
    public static String toAssStyleLine(AssStyle style){        
        return "Style: "
                ...
                + Float.toString(style.getOutline()) + ","
                + Float.toString(style.getShadow()) + ","
